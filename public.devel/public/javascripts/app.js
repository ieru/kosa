...
function Graph() {
   ...
   this.setGraph = function (paramgraph) {
      graph = paramgraph;
   };
   ...
   var getTree = function() {
          ...
          return function(nodeId, level) {
            var subtree = eval('(' + sampleTree.replace(/id:\"([a-zA-Z0-9]+)\"/g, 
            function(all, match) {
              return "id:\"" + match + "_" + i + "\""  
            }) + ')');
