  ...
  draw: function (json, context){
      ...
      context.graph = new $jit.ST({
          ...
          request: function(nodeId, level, onComplete) {
            ...
            var ans = eval(context.getTree(nodeId, level));
      ...
      // load json data
      context.graph.loadJSON(eval( '(' + this.json + ')' ));
      // compute node positions and layout
      context.graph.compute();
      // emulate a click on the root node.
      context.graph.onClick(context.graph.root);
  },
